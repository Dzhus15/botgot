...
📝 <b>Видео из текста</b> - создайте видео по текстовому описанию
🖼 <b>Видео из изображения</b> - оживите изображение с помощью ИИ

💡 <b>Стоимость:</b> 10 кредитов за видео (749₽)
    """
